export class Game
{
	static default_positionR: number = 50;
	static default_positionBx: number = 50;
	static default_positionBy: number = 50;
	static default_update: number = 60;
	static default_size_racket: number = 10;
	private _id: string;
